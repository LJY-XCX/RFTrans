...
def create_grid_image(inputs, outputs, flows, max_num_images_to_save=3):
    ...
    mask_invalid_pixels = torch.all(flow_tensor == 0, dim=1, keepdim=True)
    ...
    images = torch.cat((img_tensor_rgb, output_tensor_rgb, flow_tensor, mask_invalid_pixels_rgb), dim=3)
