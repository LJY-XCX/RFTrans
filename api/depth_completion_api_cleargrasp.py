...
from . import inference_models_cleargrasp, utils
...
class DepthToDepthCompletion(object):
    ...
    def __init__(
        ...
        self.inferenceNormals = inference_models_cleargrasp.InferenceNormals(normalsWeightsFile=normalsWeightsFile,
                                                                  normalsModel=normalsModel,
                                                                  imgHeight=normalsInferenceHeight,
                                                                  imgWidth=normalsInferenceWidth)
        self.inferenceOutlines = inference_models_cleargrasp.InferenceOutlines(outlinesWeightsFile=outlinesWeightsFile,
        ...
        if masksWeightsFile:
            self.inferenceMasks = inference_models_cleargrasp.InferenceMasks(masksWeightsFile=masksWeightsFile,
    ...
    def estimate_normals_write_ptcloud(self, filename, xyz_points, height, width):
        ...
        # to speed up the whole pipeline TODO@tutian
        # calc_normal = False
        # if not calc_normal:
